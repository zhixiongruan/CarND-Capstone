...
class TLClassifier(object):
    def __init__(self, is_site):
        ...
        self.boxes = self.sess_graph.get_tensor_by_name('detection_boxes:0')
        self.scores = self.sess_graph.get_tensor_by_name('detection_scores:0')
        self.classes = self.sess_graph.get_tensor_by_name('detection_classes:0')
    ...
    def get_classification(self, image, wp = 0):
        ...
        (boxes, scores, classes) = self.sess.run([self.boxes, self.scores, self.classes], feed_dict={self.image_tensor: image_expanded})
